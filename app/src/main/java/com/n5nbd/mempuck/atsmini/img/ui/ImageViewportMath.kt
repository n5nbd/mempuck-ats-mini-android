...
internal fun fitPlacement(
    ...
    val top = if (topAligned) 0f else (viewportHeight - height) / 2f
...
internal fun imagePointAt(
    ...
    x = ((tapX - placement.left) / placement.scale).coerceIn(0f, imageWidth.toFloat()),
    y = ((tapY - placement.top) / placement.scale).coerceIn(0f, imageHeight.toFloat()),
)
