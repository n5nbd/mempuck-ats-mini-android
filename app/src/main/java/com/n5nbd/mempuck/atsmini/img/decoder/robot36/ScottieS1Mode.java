...
Timing and RGB channel structure adapted from Scottie 1 by Ahmet Inan.
...
final class ScottieS1Mode {
    static final String NAME = "SCOTTIE S1";
    static final int VIS_CODE = 60;
    ...
    ScottieS1Mode(int sampleRate) {
        ...
        double channelSeconds = 0.138240;
        double scanLineSeconds = 0.428220;
    ...
    boolean decodeScanLine(
        ...
        if (pixelBuffer.pixels.length < horizontalPixels
            ...
            throw new IllegalArgumentException("Scottie S1 decode buffers are too small");
        }
