...
Timing and RGB channel structure adapted from MartinM1 by Ahmet Inan.
...
final class MartinM1Mode {
    static final String NAME = "MARTIN M1";
    static final int VIS_CODE = 44;
    ...
    boolean decodeScanLine(
        ...
        if (pixelBuffer.pixels.length < horizontalPixels
            ...
            throw new IllegalArgumentException("Martin M1 decode buffers are too small");
        }
